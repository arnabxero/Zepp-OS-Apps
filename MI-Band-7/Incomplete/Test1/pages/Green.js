  ...
  (function () {
    ...
    F.module = DeviceRuntimeCore.Page({
      init_view() {
        ...
        const BAD = 10;
        const FINISH = 11;
        const SAVE_KEY = "GREEN_SAVING";
        const SAVE_KEY_CURRENT = "GREEN_SAVING_CURRENT";
        var wdMap = {};
        var currentData = {};
        function setBlockSrc(a, b, c) {
          ...
          if (c == WALL) {
            e = "images3" + path + "wall.png";
          } else if (c == SPACE) {
            if (f) {
              e = "images3" + path + "ground1.png";
            } else {
              e = "images3" + path + "ground1.png";
            }
          } else if (c == PLAYER) {
            e = "images3" + path + "ground2.png";
           } else if (c == FILL) {
            e = "images3" + path + "ground2.png";
          } else {
            e = "";
