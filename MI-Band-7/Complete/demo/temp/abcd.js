try {
  (() => {
    ...
    let timeHourTensFontArray,
      timeHourOnesFontArray,
      timeMinutesTensFontArray,
      timeMinutesOnesFontArray;
    ...
    function updateTime() {
      setImgNumber(
        timeHourTens,
        timeHourTensFontArray,
        parseInt(jstime.format_hour / 10)
      );
      setImgNumber(
        timeHourOnes,
        timeHourOnesFontArray,
    ...
    function updateWeather() {
      ...
      if (forecastData.count) {
        ...
        weatherWidget.setProperty(
          hmUI.prop.TEXT,
          element.high + "u." + element.low + "u"
        );
      }
    }
