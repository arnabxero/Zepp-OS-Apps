...
const down_btn = hmUI.createWidget(hmUI.widget.IMG, {
    x: 72,
    y: 440,
    w: 50,
    h: 50,
    src: "button/down_normal.png",
  });
  ...
  down_btn.addEventListener(hmUI.event.CLICK_UP, function (a) {      
    clickedDown = false;       
    console.log("click downUPPPPP");
  });
