Page({
    build(){
        ...
        hmUI.createWidget(hmUI.widget.FILL_RECT, {
            ...
            w: 190,
            h: 190,
            color: theme  == 0 ? 0x585858 : 0x0f171f,
            radius: 8,
          });
          ...
          g = {
            ...
            bot: function () {
              for (let i = 0; i < this.wincomb.length; i++) {
                ...
                if (!this.curw) {
                  ...
                  if (
                    this.field[nc[0]] === 2 && this.field[nc[1]] === 2 ||
                    this.field[nc[2]] === 2 && this.field[nc[1]] === 2 ||
                    this.field[nc[2]] === 2 && this.field[nc[0]] === 2
                  ) {
                    var isNotPlayer1 = ![
                      this.field[nc[0]],
                      this.field[nc[1]],
                    ...
                    if (isNotPlayer1) {
                      ...
                      this.selfield = nc[firstZeroIndex];
              ...
              for (let i = 0; i < this.wincomb.length; i++) {
                let nc = this.wincomb[i];
                if (
                  this.field[nc[0]] === 1 && this.field[nc[1]] === 1 &&
                  !this.curw
                ) {
                  this.selfield = nc[2];
                ...
                if (
                  this.field[nc[1]] === 1 && this.field[nc[2]] === 1 &&
                  !this.curw
                ) {
                  this.selfield = nc[0];
                  if (this.field[this.selfield] === 0) {
                ...
                if (
                  this.field[nc[0]] === 1 && this.field[nc[2]] === 1 &&
                  !this.curw
                ) {
                  this.selfield = nc[1];
                  if (this.field[this.selfield] === 0) {
              ...
              this.ffield = [];
              for (
                let f = 0; f < this.field.length; f++
              ) if (this.field[f] === 0) this.ffield.push(f);
              if (!this.curw) {
                this.selfield =
                  this.ffield[Math.floor(Math.random() * this.ffield.length)];
                this.field[this.selfield] = 2;
                let xxyy = this.cord[this.selfield].split("/");
                let xx = Number(xxyy[0]) + 2;
                let yy = Number(xxyy[1]) + 2;
            ...
            checkWinner: function () {
              ...
              if (!winnerFound && !this.field.includes(0)) {
                ...
                this.FaC.push(bg);
                this.FaC.push(twin);
              } else if (!winnerFound) return false;
            },
            conf: function () {
