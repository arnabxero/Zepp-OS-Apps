  ...
  (function () {
    ...
    F.module = DeviceRuntimeCore.Page({
      init_view() {
        ...
        var on_liane = false;
        const colors_sky = [
          0x33afff, 0x2ea0e9, 0x288ed0, 0x2780b9, 0x1d6c9e, 0x145681, 0x0d4366,
          0x06314c,
        ];
        ...
        var score_timer = timer.createTimer(0, 100, function () {
          score++;
          update_score();
          if (max_alto - score < 299 && can_flag == true && score > max_alto) {
            can_flag = false;
            create_flag();
          }
          if (score > max_alto) {
        ...
        function nitro(increase) {
          ...
          let quit_timer = timer.createTimer(0, 100, function () {
            ...
            if (floor_arg[floor_num] != "w" && floor_arg[floor_num] != "br") {
              sec += 0.1;
              if (sec > shield_dur) {
                shield_status = false;
                player.setProperty(hmUI.prop.MORE, {
          ...
          timer.createTimer(0, 25, function () {
            ...
            if (floor_num + game_vel < floor_arg.length) {
              ...
              if (ballom == true) {
                ...
                if (player_y <= ground - 12 && floor_arg[floor_num] == "b") {
                  bounce();
                }
            ...
            if (rock_generation == true && gameover == false) {
              ...
              if (current_x > end_rock) {
                ...
                if (
                  ...
                  player_x + 61 <= current_x + rock_weights[rock_selected] &&
                  ...
                  if (
                    player_y + 17 >= rock_x[rock_selected] &&
                    player_y + 17 <=
                      rock_x[rock_selected] + rock_heights[rock_selected] - 13
                  ) {
