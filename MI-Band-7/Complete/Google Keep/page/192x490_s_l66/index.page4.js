                ...
                m.module = DeviceRuntimeCore.Page({
                    init_view: function () {
                        ...
                        hmUI.createWidget(hmUI.widget.BUTTON, {
                            ...
                            text: "Archive",
                            click_func: function () {
                            hmFS.SysProSetChars("textofuser2", "");
                             hmApp.goBack()
                        ...
                        var delbutton = keyboard.createWidget(hmUI.widget.BUTTON, {
                            ...
                            text: "⨉",
                            click_func: function () {
                                ustext1 = ustext1.substring(0, ustext1.length - 1)
                                update();
                            }
                        })
			...
			var itemtoseeallbuttons = keyboard.createWidget(hmUI.widget.FILL_RECT, {
			    ...
			    color: 0x000000,
                        ...
                        function update() {
                            ...
                            const { width, height } = hmUI.getTextLayout(ustext1, {
                                text_size: 20,
                                text_width: 192
                            })
                            textuser.setProperty(hmUI.prop.MORE, { text: ustext1, h: height })
                            if(height>162){
                            ...
                            hmFS.SysProSetChars("textofuser2", ustext1)
                        }    
                        update()      
                    },
                    onInit: function () {
