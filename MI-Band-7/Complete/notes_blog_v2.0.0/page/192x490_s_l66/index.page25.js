        ...
        try {
            (function () {
                ...
                m.module = DeviceRuntimeCore.Page({
                    init_view: function () {
                        var ustextx = hmFS.SysProGetChars("precolorrecus");
                        var colt = hmFS.SysProGetChars("precolortextus");
                        var ustext = "0x"
...
hmUI.createWidget(hmUI.widget.STROKE_RECT, {
      ...
      color: 0xffffff
                        ...
                        hmUI.createWidget(hmUI.widget.BUTTON, {
                            ...
                            click_func: function () {
                                //delfunc = 0
                                ustext = "0x" + ustextx.substring(2, ustextx.length)
                                update();
                            }
                        })
			...
			var itemtoseeallbuttons = keyboard.createWidget(hmUI.widget.FILL_RECT, {
			    ...
			    color: 0x000000,
                        ...
                        function update() {
                            ...
                            if(ustext.length == 8 && ustextx != colt && ustext.substring(0, 6) != colt.substring(0, 6)){
                            hmFS.SysProSetChars("precolorrecus", ustext);
                            hmApp.gotoPage({ url: 'page/192x490_s_l66/index.page26', param: '...' })
                            }else if(ustext == colt){
                            hmApp.gotoPage({ url: 'page/192x490_s_l66/index.page27', param: '...' })
                            }else if(ustext.substring(0, 6) == colt.substring(0, 6) && ustext.length == 8){
                            hmApp.gotoPage({ url: 'page/192x490_s_l66/index.page30', param: '...' })
                            }
                        }       
                    },
                    onInit: function () {
