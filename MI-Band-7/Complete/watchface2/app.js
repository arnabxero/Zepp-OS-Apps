try {
    (() => {
        ...
        t() ? DeviceRuntimeCore.HmUtils.gettextFactory(n, t().__globals__.lang, "en-US") : console.log(n);
        let r = o();
        ...
        }, t().__globals__.gettext = t() ? DeviceRuntimeCore.HmUtils.gettextFactory(n, t().__globals__.lang,
            "en-US") : console.log(n)
    })()
} catch (e) {
    console.log(e)
